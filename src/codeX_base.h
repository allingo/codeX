...
#ifndef __CODEX_BASE_H__
#define __CODEX_BASE_H__

#include <assimp/matrix3x3.h>
#include <assimp/matrix4x4.h>

#define CODEX_PI (3.14159265359)
#define ToRadian(x) (float)(((x) * CODEX_PI / 180.0f))
#define ToDegree(x) (float)(((x) * 180.0f / CODEX_PI))
...
#define INVALID_CODEX_VALUE (0xffffffff)
